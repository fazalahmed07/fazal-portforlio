...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "fazalahmed383@gmail.com",
    href: "mailto:fazalahmed383@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+91 8884519011",
    href: "tel:+91 8884519011",
  },
  {
    icon: MapPin,
    label: "Location",
  ...
  const handleSubmit = async(e) =>{
    ...
    try{
      ...
      if(!serviceId || !templateId || !public_key){
        throw new Error(
          "Emailjs config is missing please check your environment values"
        );
      }
    ...
    className="py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto ">
          <div className="glass p-8 rounded-3xl border border-primary animate-fade-in animate-delay-300">
