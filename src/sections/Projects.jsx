...
export const Projects=() => {
    return <section id="projects"className="py-32 relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 left-0 w-64 h-64 bg-highlight/30 rounded-full blur-3xl" />
        ...
        <div className="text-cenetr mx-auto ax-w-3xl mb-16">
            ...
            <p className=" text-center text-muted-foreground animate-fade-in animation-delay-200">collection of my recent works , from a complex web application to
                 innovative tools that solve the real world problems </p>
            ...
            {projects.map((project,idx) => (
                ...
                <div className="p-6 space-y-4">
                    <div className="flex items-start justify-between">
                        ...
                        group-hover:-translate-y-1 group-hover:text-primary transition-all"/>
                    </div>
