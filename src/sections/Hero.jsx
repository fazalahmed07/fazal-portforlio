...
export const Hero=() => {
    return <section className="relative min-h-screen flex items-center overflow:hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
            {[...Array(30)].map((_,i) => (
                <div className="absolute h-1.5 w-1.5 rounded-full opacity-60 "
                style={{
    ...
    Web developer - Jr React Dev
                     ...
                     <AnimatedBorderButton  href="/resume.pdf"  download="Fazal-Ahmed-Resume.pdf">
                        ...
                        <div className='realtive glass rounded-3xl p-2 glow-border'>
                            ...
                            <div className='absolute -bottom-4 -right-4 glass rounded-xl px-4 py-3 animate-float '>
                                <div className='flex items-center gap-3'>
                                    ...
                                    <span className='text-sm font-meium'>Available for work</span>
                                </div>
                            </div>
                            {/*stats*/}
            ...
            {/*skills */}
            <div className='mt-20 animate-fade-in animation-delay'>
